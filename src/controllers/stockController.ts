...
export const getTopStocks = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const YF = new YahooFinance();
        ...
        const indiantop5Quotes = await Promise.all(
            top5IndianStock.map(async (symbol) => {
                try {
...
export const getStockList = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        await updateQuotes();
        const symbolList = await download(config.nasdaq_url) as string;
...
export const getFilteredStocks = async (req: Request, res: Response) => {
...
export const topStocksByMarketCap = async (req: Request, res: Response) => {
    try {
...
export const getHistorical = async (req: Request, res: Response) => {
    try {
        ...
        const data =
            await getHistoricalFromMongo(symbl, days);
